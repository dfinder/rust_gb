    ...
    impl RegStruct{
        ...
        pub fn get_r8(&mut self, reg:SingleReg, memory: &mut MemWrap)  -> u8{
            match reg{ 
                ...
                SingleReg::H => self.H,
                SingleReg::Memptr => {
                    memory.grab_memory_8(self.get_r16(DoubleReg::HL))
                }
                SingleReg::L => self.L,
            }
        }
        ...
        pub fn set_r8(&mut self, reg:SingleReg, val:u8, memory: &mut MemWrap){
            match reg{ 
                ...
                SingleReg::Memptr => {
                    memory.set_memory_8(self.get_r16(DoubleReg::HL),val)
                },
        ...
        pub fn change_r8(&mut self, reg:SingleReg,fun: &dyn Fn(u8)->u8,mem: &mut MemWrap)->u8{
        ...
        pub fn new()->Self{  //Sets the initial states of registers??? 
            return Self{

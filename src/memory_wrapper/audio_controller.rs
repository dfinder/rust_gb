pub mod audio_controller {
    ...
    impl AudioController{
        pub fn new()->Self{
            return Self { audio_channel1: AudioChannel1::new(), audio_channel2: AudioChannel2::new(), audio_channel3: AudioChannel3::new(), audio_channel4: AudioChannel4::new(), audio_output: 0, audio_channel_mapping: 0, audio_channel_control: 0, wave_pattern: 0 }
    ...
    impl AudioChannel1{
        fn new()->Self{
            return Self { sweep: 0, sound_length: 0, envelope: 0, frequency: 0, control: 0, unmapped: 0 }
        }
    }
    ...
    impl AudioChannel2{
        fn new()->Self{
            return Self { sound_length: 0, envelope: 0, frequency: 0, control: 0 }
        }
    }
    ...
    impl AudioChannel3{
        fn new()->Self{
            return Self { enable: 0, sound_length: 0, envelope: 0, frequency: 0, control: 0, unmapped: 0 }
        }
    }
    ...
    impl AudioChannel4{
        fn new()->Self{
            return Self { sound_length: 0, volume: 0, frequency: 0, control: 0 }
        }
    }
